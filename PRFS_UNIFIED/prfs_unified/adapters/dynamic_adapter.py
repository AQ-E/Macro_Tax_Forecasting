...
# adapters/ → prfs_unified/ → PRFS_UNIFIED/ → Pakistan_Income_Tax_Slabs_app/
_PROJ_ROOT = os.path.abspath(os.path.join(_THIS_DIR, "..", "..", ".."))

_CANDIDATE_PRFS_DIRS = [
    os.path.join(_PROJ_ROOT, "Macro_Tax_Forecasting_Diag", "PRFS"),
    os.path.abspath(os.path.join(_THIS_DIR, "..", "..", "..", "PRFS")),
    os.path.abspath(os.path.join(_THIS_DIR, "..", "..", "PRFS")),
    os.path.join(".", "PRFS"),
]

for _cand in _CANDIDATE_PRFS_DIRS:
